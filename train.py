...
if __name__ == "__main__":
    ...
    plt.ylabel('Loss')
    plt.title('Training and Validation Loss Curve (No Attention - Greedy Decoding)')
    plt.legend()
    plt.grid(True)
    ...
    plt.ylabel('PPL')
    plt.title('Training and Validation Perplexity Curve (No Attention - Greedy Decoding)')
    plt.legend()
    plt.grid(True)
